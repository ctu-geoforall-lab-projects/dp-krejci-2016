...
%%% ML: Over years (viz prvni veta odstavce)
	them.   Over years of innovation, SQL relational databases reached limits
%%% ML: and closely connected (veta zni divne)
	...
	exporting and visualization of the result in GIS. The process cost time, and
%%% ML: posledni veta?
	without correct process workflow is not effective.
