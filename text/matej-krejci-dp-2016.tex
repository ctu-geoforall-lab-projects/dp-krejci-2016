...
%%% ML: hm, from means sense... OK
	...
	\end{abstractpage}
		...
		\begin{abstractx}{czech}
		 		...
		 		V rámci praktické časti byl implementován GRASS Hadoop Framework, který obsahuje moduly umožňující komunikaci mezi GRASS a Hadoop/Hive.Tímto nástrojem se ovládají knihovny psané pro systém Hadoop a je zajištěna konverze vektorových map, jejich přenos a správa tabulek v databázi.
...
...
  File has been copied to: 
	...
	\begin{figure}[!htbp]
		...
		\caption[CR boundaries vector]{\centering Czech Republic map for clipping the Europedataset.}
		\label{map_cz}
	\end{figure} 
