...
with "Hadoop Streaming" any programming language can be used. 
...
Several ways how to use HDFS interactively are available. In analogy to filesystem,  is  the main task to move data from local data to HDFS, access it and remove. As in standard filesystem, in HDFS is provided permission model as well. In paragraphs below are described access methods to HDFS and permissions models.
